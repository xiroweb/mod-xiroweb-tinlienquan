...
class mod_xiroweb_tinlienquanInstallerScript
{
...
<div class="template-intro">
				...
				<div class="template-intro-container">
					...
					<div class="span12">
						<h1 class="intro-header-title">
							<?php echo Text::_('MOD_XIROWEB_TINLIENQUAN'); ?>
						</h1>
						</div>
					</div>
					...
					<div class="template-intro-container">
						<div class="row-fluid">
							<div class="intro-quote lead">
								<?php echo Text::_('MOD_XIROWEB_TINLIENQUAN_INSTALL_DESC'); ?>
							</div>
						</div>
						<div class="row-fluid">
							<div class="span12">
			...
			<div class="intro-footer">
				<h3 class="text-center"><?php echo Text::_('MOD_XIROWEB_TINLIENQUAN_INSTALL_DESC2'); ?></h3>
				<ul class="version-history">
					<li class="text-center"><?php echo Text::_('MOD_XIROWEB_TINLIENQUAN_INSTALL_DESC3'); ?></li>
				</ul>
				<div class="template-intro-container">
					<a class="btn btn-success btn-large" target="_blank" href="https://www.xiroweb.com/app/xiroweb-module-tin-lien-quan"><?php echo Text::_('MOD_XIROWEB_TINLIENQUAN'); ?></a>
				</div>
			</div>
		</div>
